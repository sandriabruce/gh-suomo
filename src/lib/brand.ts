...
export const INTERESTS_CATALOG: ModeTagged[] = [
  ...
  { label: "Fine dining",        modes: ["spark"] },
  { label: "Champagne taste",    modes: ["spark"] },
  { label: "Long drives",        modes: ["spark"] },
  { label: "Deep conversations", modes: ["spark"] },
  { label: "Sensual energy",     modes: ["spark"] },
  { label: "Slow mornings",      modes: ["spark"] },
  { label: "Late nights",        modes: ["spark"] },
  { label: "Good wine",          modes: ["spark"] },
  { label: "Luxury travel",      modes: ["spark"] },
  { label: "Bold choices",       modes: ["spark"] },
  { label: "Chemistry",          modes: ["spark"] },
  { label: "No games",           modes: ["spark"] },
];
...
export const PROMPTS_CATALOG: ModeTagged[] = [
  ...
  // Spicy-only — bold, sensual, revealing
  { label: "What I want from a connection at this stage…",       modes: ["spark"] },
  { label: "My idea of a perfect evening is…",                   modes: ["spark"] },
  ...
  { label: "I will never apologise for…",                        modes: ["spark"] },
  { label: "The thing that turns a good evening into a great one…", modes: ["spark"] },
  { label: "At 2am I am…",                                       modes: ["spark"] },
];
